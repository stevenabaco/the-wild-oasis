...
function Menus({ children }) {
	const [openId, setOpenId] = useState(""); // State to kep track of which menu is open using the id of the menu
  const [position, setPosition] = useState(null); // State to keep track of the position of the menu
